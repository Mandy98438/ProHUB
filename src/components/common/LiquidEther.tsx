...
`;
    ...
    // ... (include all other shader code exactly as provided)
    const line_vert = `
  attribute vec3 position;
  uniform vec2 px;
  precision highp float;
...
`;
    ...
    c = pow(c, vec3(0.8)); // Increase brightness
    vec3 outRGB = mix(bgColor.rgb, c, lenv);
    float outA = mix(bgColor.a, 1.0, lenv * 0.9);
...
`;
    ...
    // ... (continue with all the shader pass classes and simulation code)
